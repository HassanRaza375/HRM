  ...
  <v-row>
    ...
    <v-col cols="12">
      <div class="d-flex justify-center align-center">
        <div class="w-100 d-flex align-center justify-center" style="height: 80vh; max-width: 500px">
          <div class="w-100">
            <form action="" @submit="handleLogin">
              <div class="d-flex align-center justify-center mb-5 pb-4">
                <img src="https://frontjp.shineauto.info/_ipx/s_136x45/assets/images/header-logo.svg" width="140"
                  height="47" loading="lazy" alt="icon" />
              </div>

              <v-text-field label="Username" variant="solo" class="mb-2" v-model="credentials.username" />

              <v-text-field v-model="credentials.password" label="Password" :type="showPassword ? 'text' : 'password'"
                variant="solo" class="mb-2 cursor-pointer" @click:append-inner="showPassword = !showPassword"
                :append-inner-icon="showPassword ? 'mdi-eye' : 'mdi-eye-off'" />

              <div class="d-flex align-center justify-center">
                <v-btn :loading="loading" color="primary" block size="x-large" type="submit">
                  Login
                </v-btn>
              </div>
